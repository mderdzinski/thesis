...
\newcommand{\dphilong}{$\Delta\phi(\mathrm{j}_{1234},E_{\mathrm{T}}^{\mathrm{miss}})$}
\newcommand{\htovermet}{$|\vec{H}_{\mathrm{T}}^{\mathrm{miss}}-\vec{E}_{\mathrm{T}}^{\mathrm{miss}}| / E_{\mathrm{T}}^{\mathrm{miss}}$}
